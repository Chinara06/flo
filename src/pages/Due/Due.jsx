                ...
                <div className="ovulation__left">
                    ...
                    <div className="ovulation__right">
                        <div className="ovulation__right-img">
                            <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-750x-inset/07/9487-01_1006x755.jpg?v=1-0" alt="#" width={"374"} height={"280"}/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="data__right">
                        <div className="data__right-lists active">
                            ...
                            <div className="data__right-list">
                                <ol>
                                    <li>
                                        <a href="">How far along am I?</a>
                                    </li>
                                    <li>
                                        <a href="">How is due date calculated?</a>
                                    </li>
                                    <li>
                                        <a href="">How to calculate due date if you’ve had IVF</a>
                                    </li>
                                    <li>
                                        <a href="">How accurate is due date?</a>
                                    </li>
                                    <li>
                                        <a href="">What day did I get pregnant?</a>
                                    </li>
                                    <li>
                                        <a href="">Can my due date change?</a>
                                    </li>
                                    <li>
                                        <a href="">Can I plan my due date?</a>
                                    </li>
                                    <li>
                                        <a href="">Due date tracking with Flo</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
