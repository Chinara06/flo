...
import {getHcg} from "../../redux/hcg/hcg";
import { AiOutlineMinus } from "react-icons/ai";
import { FiPlus } from "react-icons/fi";

const Hcg = () => {
    const {data} = useSelector(store => store.hcg);
                    ...
                    <div className="ovulation__row">
                        <div className="ovulation__texts">
                            ...
                            <p className="ovulation__desc">
                                Our hCG calculator will help you make sense of your hCG levels at home during early pregnancy and keep track of how they are progressing by week.
                            </p>
                        </div>
                    </div>
                    <div className="ovulation__right">
                        <div className="ovulation__right-img">
                            <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-750x-inset/03/9493-01_1006x755.jpg?v=1-0" alt="#" width={"374"} height={"280"}/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="data__left">
                        <div className="data__panel">
                            <p className="data__desc">
                                Updated <span>28 November 2022</span> 2022 | Published <span>06 July 2022</span>
                            </p>
                            <div className="data__text">
                                <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-48x48/00/4710-Angela_Jones_Light.png?v=1-0" alt="#" width={"24"} height={"24"}/>
                                Medically reviewed by <span>Dr. Angela Jones</span>,Obstetrician, gynecologist, and attending physician, Jersey Shore University Medical Center, New Jersey, US
                            </div>
                        ...
                        <div className="image">
                            <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-1000x-inset/08/9898-01_1006x755.jpg?v=1-0" alt="#" width={"720"} height={"500"}/>
                    ...
                    <div className="data__right">
                        <div className="data__right-lists">
                            ...
                            <div className="data__right-list">
                                <ol>
                                    <li>
                                        <a href="">When does hCG start?</a>
                                    </li>
                                    <li>
                                        <a href="">Beta hCG calculator: What does hCG show?</a>
                                    </li>
                                    <li>
                                        <a href="">Beta hCG calculator: What if hCG levels are low?</a>
                                    </li>
                                    <li>
                                        <a href="">hCG progression: What is a normal hCG level in pregnancy? When do hCG levels stop doubling?</a>
                                    </li>
                                    <li>
                                        <a href="">hCG levels in early pregnancy</a>
                                    </li>
                                    <li>
                                        <a href="">hCG doubling time: What does it mean?</a>
                                    </li>
                                    <li>
                                        <a href="">At what hCG level will I miscarry?</a>
                                    </li>
                                    <li>
                                        <a href="">How Flo can help</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
