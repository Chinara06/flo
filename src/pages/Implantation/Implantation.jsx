...
import {getImplantation} from "../../redux/implantation/implantation";
import { AiOutlineMinus } from "react-icons/ai";
import { FiPlus } from "react-icons/fi";

const Implantation = () => {
    const {data} = useSelector(store => store.implantation);
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(getImplantation())
    },[])
    return (
                ...
                <div className="ovulation__left">
                    ...
                    <div className="ovulation__right">
                        <div className="ovulation__right-img">
                            <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-750x-inset/04/9424-Woman%20holding%20a%20calendar%20showing%20her%20period%20and%20the%20date%20of%20ovulation%20and%20implantation%201006x755%20%282%29.jpg?v=1-0" alt="#" width={"374"} height={"280"}/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="data__left">
                        <div className="data__panel">
                            ...
                            <div className="data__text">
                                <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-48x48/04/10304-Allison%20Rodgers_lightgrey_2024_1.png?v=1-0" alt="#" width={"24"} height={"24"}/>
                                Medically reviewed by <span>Dr. Allison K. Rodgers, </span>,Associate professor of obstetrics, gynecology, and reproductive endocrinology, Yale University School of Medicine, Connecticut, US
                            </div>
                            <p className="data__subtitle">
                                Written by <span>Alice Broster</span>
                            </p>
                        </div>
                    ...
                    <div className="data__right">
                        <div className="data__right-lists">
                            ...
                            <div className="data__right-list">
                                <ol>
                                    <li>
                                        <a href="">How long is my cycle?</a>
                                    </li>
                                    <li>
                                        <a href="">What are the signs of your period coming?</a>
                                    </li>
                                    <li>
                                        <a href="">Why is my period late?</a>
                                    </li>
                                    <li>
                                        <a href="">Period tracking with Flo</a>
                                    </li>
                                </ol>
                            </div>
