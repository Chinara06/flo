...
import {getTest} from "../../redux/test/test";
                ...
                <div className="ovulation__left">
                    ...
                    <div className="ovulation__right">
                        <div className="ovulation__right-img">
                            <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-750x-inset/01/9491-01_1006x755.jpg?v=1-0" alt="#" width={"374"} height={"280"}/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="data__left">
                        <div className="data__panel">
                            ...
                            <div className="data__text">
                                ...
                                Medically reviewed by <span> Dr. Jennifer Boyle,</span>,Obstetrician and gynecologist, Massachusetts General Hospital, Massachusetts, US
                            </div>
                    ...
                    <div className="data__right">
                        <div className="data__right-lists">
                            ...
                            <div className="data__right-list">
                                <ol>
                                    <li>
                                        <a href="">Is there a difference between pregnancy tests?</a>
                                    </li>
                                    <li>
                                        <a href="">When is a pregnancy test positive?</a>
                                    </li>
                                    <li>
                                        <a href="">When is an early pregnancy test positive?</a>
                                    </li>
                                    <li>
                                        <a href="">Are there variations in hCG levels?</a>
                                    </li>
                                    <li>
                                        <a href="">When to take a pregnancy test</a>
                                    </li>
                                    <li>
                                        <a href="">When to take an early pregnancy test</a>
                                    </li>
                                    <li>
                                        <a href="">How to take an at-home urine test</a>
                                    </li>
                                </ol>
                            </div>
