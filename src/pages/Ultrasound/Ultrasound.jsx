...
import {getUltrasound} from "../../redux/ultrasound/ultrasound";
import { AiOutlineMinus } from "react-icons/ai";
import { FiPlus } from "react-icons/fi";

const Ultrasound = () => {
    const {data} = useSelector(store => store.ultrasound);
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(getUltrasound())
    },[])
    return (
                ...
                <div className="ovulation__left">
                    ...
                    <div className="ovulation__right">
                        <div className="ovulation__right-img">
                            <img src="https://flo.health/cdn-cgi/image/quality=85,format=auto/uploads/media/sulu-750x-inset/01/9511-01_1006x755.jpg?v=1-0" alt="#" width={"374"} height={"280"}/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="data__left">
                        <div className="data__panel">
                            <p className="data__desc">
                                Updated <span> 30 August 2023</span> 2022 | Published <span>27 September 2022</span>
                            </p>
                            <p className="data__subtitle">
                                Written by <span>Flo content team</span>
                            </p>
                        </div>
